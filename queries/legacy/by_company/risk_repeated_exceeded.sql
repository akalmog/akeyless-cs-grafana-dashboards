-- Exceeded clients summary — one row per customer + product in latest month.
...
CompanySummary AS (
    SELECT
        le.company_name,
        le.product,
        lm.report_month AS latest_month,
...
SELECT
    ...
    latest_peak_date AS "Latest Peak Date",
